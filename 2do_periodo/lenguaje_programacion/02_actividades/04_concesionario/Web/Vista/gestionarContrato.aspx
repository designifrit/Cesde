...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Concesionario / Contrato</title>
            ...
            <div id="nav_menu" class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="gestionarContrato.aspx">Contrato</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <main class="container">
        ...
        <form id="form4" runat="server">
            <div class="form-row">
                ...
                <div class="form-group col">
                    <label for="TextTipoVehiculo">ID Tipo de vehiculo</label>
